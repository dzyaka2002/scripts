...
if %var%==4 set l="https://www.googleapis.com/drive/v3/files/1M5tp-CtY4YPW5KBpHCRqIpnFG5NpYp4f/?key=AIzaSyD8K5qVaM7-gThnjnotPtoZPU48TaQCFjg&alt=media" & set si=6850513408 & set ovan=u24
